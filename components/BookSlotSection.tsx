  ...
  return (
    <section className="py-20 px-6 relative">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h2 className="text-4xl md:text-5xl tracking-tight mb-6 font-light apple-fade-in">
          Ready to Slide In?
        </h2>
        <p className="text-xl text-muted-foreground mb-4 max-w-2xl mx-auto font-light apple-fade-in apple-fade-in-delay-1">
          Browse upcoming dinners and book your seat through our web app.
        </p>
        <p className="text-lg text-muted-foreground mb-12 font-light apple-fade-in apple-fade-in-delay-2">
          It takes less than 2 minutes to join a table.
        </p>
        
        <div className="space-y-4 apple-fade-in apple-fade-in-delay-3">
          <Button 
            size="lg" 
